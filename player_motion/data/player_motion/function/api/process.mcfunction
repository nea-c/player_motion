...
execute if entity @s[type=minecraft:player,gamemode=spectator] run return fail
execute if entity @s[type=minecraft:player,gamemode=creative] if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{flags:{is_flying:true,is_fall_flying:false}}} run return fail
...
execute if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{flags:{is_in_water:true}}} run function player_motion:api/multiplier/in_water
execute if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{flags:{is_fall_flying:true}}} run function player_motion:api/multiplier/elytra
execute if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{flags:{is_swimming:true}}} run function player_motion:api/multiplier/swim
