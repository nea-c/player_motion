...
execute store success score #passenger_protected PlayerMotion.X run data modify entity @s Invulnerable set value 1b
execute if score #passenger_protected PlayerMotion.X matches 1 run tag @s add player_motion.restore_invulnerable
