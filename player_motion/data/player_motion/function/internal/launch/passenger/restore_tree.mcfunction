...
execute if score #passenger_launched PlayerMotion.X matches 1 unless entity @s[type=player] run data modify entity @s Motion set value [0.0d,0.0d,0.0d]
...
execute unless entity @s[type=player] run function player_motion:internal/launch/restore_invulnerable
