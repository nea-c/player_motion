...
execute if predicate {type:"entity_properties",entity:"this",predicate:{nbt:{Invulnerable:true}}} run return 0
...
execute unless data storage player_motion: _{Invulnerable:true} run return 0
