...
execute store success score #passenger_resistance PlayerMotion.X run attribute @s explosion_knockback_resistance modifier add player_motion:passenger_resistance 1 add_value
