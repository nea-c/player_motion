...
execute store success score #player_motion PlayerMotion.X run attribute @s explosion_knockback_resistance modifier add player_motion:passenger_resistance 1 add_value
execute if score #player_motion PlayerMotion.X matches 1 run tag @s add player_motion.passenger_resistance
...
execute if score #player_motion PlayerMotion.X matches 1.. run function player_motion:apply/passenger/2.prepare_boost
execute store result score #player_motion PlayerMotion.X run attribute @s explosion_knockback_resistance get
execute unless score #player_motion PlayerMotion.X matches 1 run scoreboard players set #player_motion.passenger_failed PlayerMotion.X 1
