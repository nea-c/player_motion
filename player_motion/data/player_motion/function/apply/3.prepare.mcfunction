...
execute store result score #player_motion PlayerMotion.X run compute default float {type:"ceil",input:{type:"min",inputs:[{type:"storage",storage:"player_motion:",path:"_.launch.magnitude"},1.0]}}
execute if score #player_motion PlayerMotion.X matches 0 run return fail
...
execute store result score #player_motion PlayerMotion.X run data get storage player_motion: _.launch.full_count
...
execute store result score #player_motion PlayerMotion.Y run compute default float {type:"ceil",input:{type:"storage",storage:"player_motion:",path:"_.launch.residual"}}
...
execute if score #player_motion PlayerMotion.Y matches 1 run data modify storage player_motion: _.launch.distance set compute default float {type:"mul",inputs:[{type:"sub",left:1.0,right:{type:"storage",storage:"player_motion:",path:"_.launch.residual"}},12.0]}
execute if score #player_motion PlayerMotion.Y matches 1 run data modify storage player_motion: _.launch.q set compute default float {type:"min",inputs:[{type:"max",inputs:[{type:"div",left:{type:"mul",inputs:[{type:"storage",storage:"player_motion:",path:"_.launch.unit_horizontal"},{type:"storage",storage:"player_motion:",path:"_.launch.eye_height"}]},right:{type:"storage",storage:"player_motion:",path:"_.launch.distance"}},-1.0]},1.0]}
execute if score #player_motion PlayerMotion.Y matches 1 run data modify storage player_motion: _.launch.d set compute default float {type:"negate",input:{type:"add",inputs:[{type:"mul",inputs:[{type:"storage",storage:"player_motion:",path:"_.launch.eye_height"},{type:"storage",storage:"player_motion:",path:"_.launch.unit_y"}]},{type:"mul",inputs:[{type:"storage",storage:"player_motion:",path:"_.launch.distance"},{type:"sqrt",input:{type:"max",inputs:[{type:"sub",left:1.0,right:{type:"mul",inputs:[{type:"storage",storage:"player_motion:",path:"_.launch.q"},{type:"storage",storage:"player_motion:",path:"_.launch.q"}]}},0.0]}}]}]}}
